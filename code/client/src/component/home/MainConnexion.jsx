			...
			<section id="connexion">
				...
				>
					...
					<section id="inscription">
						...
						<p>
							Vous souhaitez contribuer à une belle cause tout en renforçant les
							liens avec vos voisins ? Inscrivez-vous dès maintenant sur{" "}
							<span>VAG</span> et découvrez une manière simple et gratifiante de
						...
						<ul id="pourquoi">
							...
							<li className="voisins">
								...
								offertes par vos voisins pour compléter vos repas sans débourser
								un centime.
							</li>
							<li className="voisins">
								<strong>
								...
								Rencontrez vos voisins, échangez des recettes et des astuces, et
								renforcez le sentiment de communauté.
							</li>
						</ul>
						<p>
							En rejoignant <span>VAG</span>, vous devenez acteur d'une chaîne
							de solidarité locale et aidez à construire un quartier plus uni et
							durable.
						</p>
						<p>
							Inscrivez-vous dès aujourd'hui et faites partie de ce mouvement
							positif ! Ensemble, réduisons le gaspillage et enrichissons notre
							communauté
						</p>
					</section>
